...
{
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_CS, CSR_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_ISC, ISC_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_ISD, ISD_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_IMC, IMC_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_IMD, IMD_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_IPCC, IPCC_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_IPCD, IPCD_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_CLKCTL, CLKCTL_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_CS2, CSR2_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_LTRC, LTR_CTRL_DEFAULT_VALUE);
	sst_dsp_shim_write_unlocked(sst, WPT_SHIM_HMDC, HMD_CTRL_DEFAULT_VALUE);
}
